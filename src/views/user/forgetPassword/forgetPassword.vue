<template>
    <!--描述: 忘记密码-->
    <div class="forgetPassword tui-wh100">
        ...
        <div class="tui-content">
            ...
            <div class="do-box" v-else-if="active===1">
                <password-field v-model="newPassword1" label="新密码" placeholder="请输入新密码" v-validate
                ...
                <password-field v-model="newPassword2" label="确认新密码" placeholder="确认新密码" v-validate
